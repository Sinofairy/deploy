...
anchor_generator = dict(
    ...
    __graph_model_name="person_anchor",
)
...
anchor_head = dict(
    ...
    factor=1,
    group_base=8,
    __graph_model_name="person_anchor_head",
)
...
anchor_pred = dict(
    ...
    bbox_min_hw=(1, 1),
    __graph_model_name="person_anchor_pred",
)
...
anchor_desc = dict(
    ...
    __graph_model_name="person_anchor_desc",
)
...
roi_feat_extractor = dict(
    ...
    canonical_level=5,
    aligned=None,
    __graph_model_name="person_roi_feat_extractor",
)
...
roi_head = dict(
    ...
    factor=1,
    stride=2,
    __graph_model_name="person_roi_share_head",
)
...
def get_model(mode):
    ...
    return dict(
        ...
        rpn_module=dict(
            ...
            target=dict(
                __graph_model_name="person_anchor_target",
            ...
            loss=dict(
                ...
                __graph_model_name="person_anchor_loss",
            )
            if mode == "train"
            else None,
