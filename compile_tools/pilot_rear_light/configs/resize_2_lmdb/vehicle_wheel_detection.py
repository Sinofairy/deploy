...
inputs = dict(
    train=dict(
        ...
        gt_boxes=[torch.zeros((10, max_subbox_num, 5))],
        ig_regions=[torch.zeros((10, max_subbox_num, 5))],
        parent_gt_boxes=[torch.zeros((10, 5))],
        parent_ig_regions=[torch.zeros((10, 5))],
    ),
    val=dict(),
    test=dict(),
)
