...
root = "/nas/j5/model_framework/pilot_data/"
rear_light_root = "/nas/lmd/workspace/data/data/tmp_out/"
# ----- Required -----
...
datapaths = dict(
    ...
    rear_light_detection=dict(
        dict(
            train_data_paths=[
                dict(
                    idx_path=f"{rear_light_root}/rear_light_detection/idx",  # noqa
                    img_path=f"{rear_light_root}/rear_light_detection/img",  # noqa
                    anno_path=f"{rear_light_root}/rear_light_detection/anno",  # noqa
                    sample_weight=16,
                )
            ],
        ),
    ),
    rear_light_category_classification=dict(
        dict(
            train_data_paths=[
                dict(
                    idx_path=f"{rear_light_root}/rear_light_category_classification//idx",  # noqa
                    img_path=f"{rear_light_root}/rear_light_category_classification//img",  # noqa
                    anno_path=f"{rear_light_root}/rear_light_category_classification//anno",  # noqa
                    sample_weight=16,
                )
            ],
        ),
    ),
    rear_light_occlusion_classification=dict(
        dict(
            train_data_paths=[
                dict(
                    idx_path=f"{rear_light_root}/rear_light_occlusion_classification//idx",  # noqa
                    img_path=f"{rear_light_root}/rear_light_occlusion_classification//img",  # noqa
                    anno_path=f"{rear_light_root}/rear_light_occlusion_classification//anno",  # noqa
                    sample_weight=16,
                )
            ],
        ),
