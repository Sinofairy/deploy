...
anchor_generator = dict(
    ...
    __graph_model_name="cyclist_anchor",
)
...
anchor_head = dict(
    ...
    factor=1,
    group_base=8,
    __graph_model_name="cyclist_anchor_head",
)
...
anchor_pred = dict(
    ...
    bbox_min_hw=(1, 1),
    __graph_model_name="cyclist_anchor_pred",
)
...
anchor_desc = dict(
    ...
    __graph_model_name="cyclist_anchor_desc",
)
...
roi_feat_extractor = dict(
    ...
    canonical_level=5,
    aligned=None,
    __graph_model_name="cyclist_roi_feat_extractor",
)
...
roi_head = dict(
    ...
    factor=1,
    stride=2,
    __graph_model_name="cyclist_roi_share_head",
)
...
def get_model(mode):
    ...
    return dict(
        ...
        rpn_module=dict(
            ...
            target=dict(
                __graph_model_name="cyclist_anchor_target",
            ...
            loss=dict(
                ...
                __graph_model_name="cyclist_anchor_loss",
            )
            if mode == "train"
            else None,
                    ...
                    [
                        dict(
                            ...
                            per_tensor_desc=frcnn_det_desc(
                                ...
                                legacy_bbox=data_args["legacy_bbox"],
                                score_threshold_per_class=[0.43],
                                nms_threshold=[0.5],
                            ),
...
val_decoders[object_type] = (
    ...
    dict(
        ...
        __graph_model_name=f"{object_type}_decoder",
    ),
)
