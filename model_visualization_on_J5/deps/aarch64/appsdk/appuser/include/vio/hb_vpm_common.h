...
#define HB_VIO_ISP_FREE_DATA_INPUT_BUF_NULL (5002)
#define HB_VIO_ISP_GET_DATA_INPUT_BUF_NULL  (5003)
#define HB_VIO_ISP_FEEDBACK_BUF_NULL        (5004)
#define HB_VIO_ISP_OPEN_NODE_FAIL           (5005)
...
#define  HB_VIO_PYM_INIT_FAIL          (6001)
#define  HB_VIO_PYM_DEINIT_FAIL        (6002)
#define  HB_VIO_PYM_UPDATE_FAIL        (6003)
#define  HB_VIO_PYM_STOP_FAIL          (6004)
#define  HB_VIO_PYM_START_FAIL         (6005)
#define  HB_VIO_PYM_PARSER_FAIL        (6006)
#define  HB_VIO_PYM_IS_BUSY            (6007)
#define  HB_VIO_PYM_EPOLL_CREATE_FAIL  (6008)
#define  HB_VIO_PYM_EPOLL_CTL_FAIL     (6009)
#define  HB_VIO_PYM_EPOLL_WAIT_FAIL    (6010)
#define  HB_VIO_PYM_STOP_WORKING       (6011)
#define  HB_VIO_PYM_BAD_VALUE          (6012)
#define  HB_VIO_PYM_TIME_OUT           (6013)
#define  HB_VIO_PYM_INVALID_OPERATION  (6014)
#define  HB_VIO_PYM_INVALID_CONFIG     (6015)
#define  HB_VIO_PYM_NULL_POINTER       (6016)
#define  HB_VIO_PYM_BUF_MGR_FAIL       (6017)
#define  HB_VIO_PYM_OPEN_NODE_FAIL     (6018)
#define  HB_VIO_PYM_BUF_MGR_NULL       (6019)
#define  HB_VIO_PYM_ALLOC_BUF_FAIL     (6020)
#define  HB_VIO_PYM_BUF_MAP_FAIL       (6021)
#define  HB_VIO_PYM_FREE_DATA_INPUT_BUF_NULL     (6022)
#define  HB_VIO_PYM_GET_DATA_INPUT_BUF_NULL      (6023)
#define  HB_VIO_PYM_RUN_BUF_NULL       (6024)
#define  HB_VIO_PYM_RUN_INVALID_BUF    (6025)
#define  HB_VIO_PYM_RUN_WRONGSTATE     (6026)
#define  HB_VIO_PYM_FRAME_DROP         (6027)
...
#define  HB_VIO_GDC_INIT_FAIL                		(7001)
#define  HB_VIO_GDC_DEINIT_FAIL              		(7002)
#define  HB_VIO_GDC_UPDATE_FAIL              		(7003)
#define  HB_VIO_GDC_STOP_FAIL                		(7004)
#define  HB_VIO_GDC_START_FAIL               		(7005)
#define  HB_VIO_GDC_PARSER_FAIL              		(7006)
#define  HB_VIO_GDC_EPOLL_CREATE_FAIL        		(7007)
#define  HB_VIO_GDC_EPOLL_CTL_FAIL           		(7008)
#define  HB_VIO_GDC_EPOLL_WAIT_FAIL          		(7009)
#define  HB_VIO_GDC_STOP_WORKING             		(7010)
#define  HB_VIO_GDC_BUF_MGR_FAIL             		(7011)
#define  HB_VIO_GDC_BAD_VALUE                		(7012)
#define  HB_VIO_GDC_NULL_POINTER               		(7013)
#define  HB_VIO_GDC_PROCESS_FAIL             		(7014)
#define  HB_VIO_GDC_GET_STATUS_FAIL          		(7015)
#define  HB_VIO_GDC_INVALID_CONFIG           		(7016)
#define  HB_VIO_GDC_FREE_DATA_INPUT_BUF_NULL 		(7017)
#define  HB_VIO_GDC_GET_FEEDBACK_BUF_INPUT_BUF_NULL (7018)
#define  HB_VIO_GDC_WRONGSTATE_SETCFG        		(7019)
...
#define  HB_VIO_GDC_OPEN_NODE_FAIL           		(7031)
#define  HB_VIO_GDC_INVALID_DATATYPE         		(7032)
#define  HB_VIO_GDC_GET_FEEDBACK_BUF_FAIL    		(7033)
...
#define  HB_VIO_GDC_GET_DATA_INPUT_BUF_NULL  		(7045)
#define  HB_VIO_GDC_FRAME_DROP                      (7046)
